...
(function (TipsManager) {
     ...
     * @param {string} [descStr=""]    tips内容
     * @param {number} [effectType=0]  0：没有动画 1:从下到上渐现 2：从左向右 3：从右向左
     */
    ...
    function showTips(e) {
        ...
        if (this._tips == null) {
            ...
            if (!GameLayerManager.getInstance().effectLayer.contains(this._tips)) {
                GameLayerManager.getInstance().effectLayer.addChild(this._tips);
            }
    ...
    function removeTips(e) {
        ...
        if (this._tips != null) {
            var onComplete = function () {
                if (GameLayerManager.getInstance().effectLayer.contains(this._tips)) {
                    GameLayerManager.getInstance().effectLayer.removeChild(this._tips);
                    this._tips = null;
                }
            };
