...
module PopUpManager
{
     ...
     */
    export function addPopUp(panel: egret.DisplayObjectContainer, effectType: number = 0, dark: boolean = false, popUpWidth: number = 0, popUpHeight: number = 0, isAlert: boolean = false): void
    {
     ...
     */
    export function removePopUp(panel: egret.DisplayObjectContainer, effectType: number = 0): void
    {
