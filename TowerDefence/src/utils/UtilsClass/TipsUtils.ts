...
module TipsUtils
{
    ...
    export function showTipsDownToUp(str: string = "", isWarning: boolean = false): void
    {
        ...
        if (!GameLayerManager.getInstance().effectLayer.contains(effectTips))
        {
            GameLayerManager.getInstance().effectLayer.addChild(effectTips);
        }
        ...
        var onComplete2: Function = function ()
        {
            if (GameLayerManager.getInstance().effectLayer.contains(effectTips))
            {
                GameLayerManager.getInstance().effectLayer.removeChild(effectTips);
                effectTips = null;
            }
        };
